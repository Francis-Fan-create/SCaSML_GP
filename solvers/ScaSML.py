...
class ScaSML:
    ...
    def f(self, x_t, u_breve, z_breve):
        '''
        Generator function of ScaSML.

        Parameters:
            x_t (array): Input data of shape (batch_size, n_input).
            u_breve (array): Approximated u_true - u_hat.
            z_breve (array): Approximated gradient of u_breve.

        Returns:
            array: Output of the generator function of shape (batch_size,).
        '''
    ...
    def g(self, x_t):
        ...
        Returns:
            array: Output of the terminal constraint function of shape (batch_size,).
        '''
        self.evaluation_counter += 1
        eq = self.equation
        u_hat = self.GP.predict(x_t)
    ...
    def u_solve(self, n, rho, x_t):
        ...
        uncertainty = jnp.abs(self.GP.compute_PDE_loss(x_t))
