...
# python results_full_history/Linear_Convection_Diffusion/60d/experiment_run.py &
wait
...
# python results/Linear_Convection_Diffusion/60d/experiment_run.py &
wait
echo "Group 3 completed."

# Group 4
echo "Running Group 4"
# python results/Linear_Convection_Diffusion/80d/experiment_run.py &
# python results_full_history/Linear_Convection_Diffusion/80d/experiment_run.py &
wait
