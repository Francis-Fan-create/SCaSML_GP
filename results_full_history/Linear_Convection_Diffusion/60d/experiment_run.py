...
#initialize wandb
wandb.init(project="Linear_Convection_Diffusion", notes="60 d", tags=["Gaussian Process"],mode="disabled") #debug mode
# wandb.init(project="Linear_Convection_Diffusion", notes="60 d", tags=["Gaussian Process"]) #working mode
