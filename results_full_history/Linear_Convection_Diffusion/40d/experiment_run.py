...
#initialize wandb
wandb.init(project="Linear_Convection_Diffusion", notes="40 d", tags=["Gaussian Process"],mode="disabled") #debug mode
# wandb.init(project="Linear_Convection_Diffusion", notes="40 d", tags=["Gaussian Process"]) #working mode
...
test5.test(r"results_full_history/Linear_Convection_Diffusion/20d")
