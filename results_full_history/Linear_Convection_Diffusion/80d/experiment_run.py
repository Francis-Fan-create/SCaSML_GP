...
#initialize wandb
wandb.init(project="Linear_Convection_Diffusion", notes="80 d", tags=["Gaussian Process"],mode="disabled") #debug mode
# wandb.init(project="Linear_Convection_Diffusion", notes="80 d", tags=["Gaussian Process"]) #working mode
...
solver3_1=ScaSML_full_history(equation=equation,GP=solver1_1) #ScaSML object
solver3_2=ScaSML_full_history(equation=equation,GP=solver1_2) #ScaSML object
...
# test5.test(r"results_full_history/Linear_Convection_Diffusion/80d")
