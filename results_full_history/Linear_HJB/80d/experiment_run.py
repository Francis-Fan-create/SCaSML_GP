...
#initialize wandb
wandb.init(project="Linear_HJB", notes="80 d", tags=["Gaussian Process"],mode="disabled") #debug mode
# wandb.init(project="Linear_HJB", notes="80 d", tags=["Gaussian Process"]) #working mode
