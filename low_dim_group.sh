...
# python results/Linear_Convection_Diffusion/20d/experiment_run.py &
wait
...
# python results_full_history/Linear_Convection_Diffusion/20d/experiment_run.py &
wait
echo "Group 3 completed."

# Group 4
echo "Running Group 4"
# python results/Linear_Convection_Diffusion/40d/experiment_run.py &
# python results_full_history/Linear_Convection_Diffusion/40d/experiment_run.py &
wait
