...
class SimpleUniform(object):
    ...
    def test(self, save_path, rhomax=2, num_domain=100, num_boundary=20):
        '''
        ...
        sol1 = self.solver1.GPsolver(xt_domain, xt_boundary)  # sol1: ndarray, shape: (num_domain,), dtype: float
