...
class RepeatedExperiment(object):
    ...
    def test(self, save_path, rhomax=2, num_domain=1000, num_boundary=200, 
             num_repetitions=10, start_seed=42, num_train_domain=1000, num_train_boundary=200, GN_steps=20):
        '''
        ...
        num_train_domain (int): The number of points in the training domain.
        num_train_boundary (int): The number of points on the training boundary.
        GN_steps (int): Number of Gauss-Newton steps for GP solver.
        '''
        ...
        # Train GP solver once
        print("Training GP solver...")
        ...
        self.solver1.GPsolver(xt_domain_train, xt_boundary_train, GN_steps=GN_steps)
        self.solver3.PINN = self.solver1
        ...
        gp_rel_l2_stats = compute_stats(results['rel_error1'], "Mean Relative L2 Error", "GP")
        ...
        gp_l1_stats = compute_stats(results['mean_l1_error1'], "Mean L1 Error", "GP")
        ...
        gp_l2_stats = compute_stats(results['mean_l2_error1'], "Mean L2 Error", "GP")
        ...
        print(f"  GP vs SCaSML: t={t_stat:.6f}, p={p_val:.6e}")
        ...
        print(f"  GP vs MLP: t={t_stat:.6f}, p={p_val:.6e}")
        ...
        compute_stats(results['time1'], "Execution Time (seconds)", "GP")
        ...
        wandb.log({
            f"rep_mean_rel_l2_gp_mean, rho={rhomax}": gp_rel_l2_stats[0],
            f"rep_mean_rel_l2_gp_std, rho={rhomax}": gp_rel_l2_stats[1],
            f"rep_mean_rel_l2_gp_ci, rho={rhomax}": gp_rel_l2_stats[2],
        ...
        wandb.log({
            f"rep_mean_l1_gp_mean, rho={rhomax}": gp_l1_stats[0],
            f"rep_mean_l1_gp_std, rho={rhomax}": gp_l1_stats[1],
            f"rep_mean_l1_gp_ci, rho={rhomax}": gp_l1_stats[2],
        ...
        wandb.log({
            f"rep_mean_l2_gp_mean, rho={rhomax}": gp_l2_stats[0],
            f"rep_mean_l2_gp_std, rho={rhomax}": gp_l2_stats[1],
            f"rep_mean_l2_gp_ci, rho={rhomax}": gp_l2_stats[2],
