...
equation=Grad_Dependent_Nonlinear(n_input=2,n_output=1)
...
rhomax=test1.test(r"results/Grad_Dependent_Nonlinear/2d")
#run the test for SimpleUniform
test2=SimpleUniform(equation,solver1,solver2,solver3)
test2.test(r"results/Grad_Dependent_Nonlinear/2d")
#run the test for ConvergenceRate
test3=ConvergenceRate(equation,solver1,solver2,solver3)
test3.test(r"results/Grad_Dependent_Nonlinear/2d")
