...
#initialize wandb
wandb.init(project="Neumann_Boundary", notes="100 d", tags=["Gaussian Process"],mode="disabled") #debug mode
# wandb.init(project="Neumann_Boundary", notes="100 d", tags=["Gaussian Process"]) #working mode
